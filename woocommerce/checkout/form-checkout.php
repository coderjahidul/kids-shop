...
<form name="checkout" method="post" class="checkout woocommerce-checkout kids-shop-checkout-form" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data" aria-label="<?php echo esc_attr__( 'Checkout', 'woocommerce' ); ?>">
	<div class="kids-shop-checkout-shell">
		<div class="kids-shop-checkout-left">
			<div class="kids-shop-checkout-panel">
				...
				<div class="kids-shop-checkout-divider"></div>
				<div class="kids-shop-payment-title"><?php esc_html_e( 'Select a Payment Option', 'kids-shop' ); ?></div>
